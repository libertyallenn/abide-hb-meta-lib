...
#==============Shell script==============#
# Load evironment
source /home/data/nbc/misc-projects/meta-analyses/Hampson_rdoc-meta-analysis/env/activate_env
set -e

PROJECT_DIR="/home/data/nbc/misc-projects/meta-analyses/Hampson_rdoc-meta-analysis"

# Setup done, run the command
cmd="python ${PROJECT_DIR}/social-rdoc_cluster-correlations.py \
