...
if plot_dendrogram:
    ...
    linkage_matrix = linkage(corrmat, method="ward")
    dendrogram(linkage_matrix, color_threshold=10, above_threshold_color="y")
    plt.title("Hierarchical Clustering Dendrogram")
    plt.xlabel("Experiments")
    plt.ylabel("Cophenetic Distance")
    plt.savefig(op.join(output_dir, "dendogram_test2.png"))
    plt.close()
